...
# ── Sidebar ──────────────────────────────────────────────────
with st.sidebar:
    st.markdown("<h2 style='color:#34d399;font-size:1.4rem;margin-bottom:0;'>💧 EcoXAI</h2>", unsafe_allow_html=True)
    st.markdown("<p style='color:#d1d5db;font-size:0.85rem;margin-top:0.2rem;'>Water footprint monitor</p>", unsafe_allow_html=True)
    st.markdown("---")

    st.markdown("<p style='color:#f3f4f6;font-weight:600;font-size:0.9rem;'>Adjust conditions</p>", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("""
    <p style='color:#d1d5db;font-size:0.88rem;font-weight:600;margin-bottom:0.4rem;'>📍 Monitored Cities</p>
    <p style='color:#34d399;font-size:0.95rem;font-weight:500;line-height:2;'>
    🔵 Mumbai<br>🟢 Hyderabad<br>🟡 Chennai
    </p>
    """, unsafe_allow_html=True)
